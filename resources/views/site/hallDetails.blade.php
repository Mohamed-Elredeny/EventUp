        ...
        <div class="row">
                ...
                <div class="blog-post">
                    ...
                    <div class="post-content">
                        <div class="meta">
                            ...
                            <span class="meta-part"><a href="#"><i class="lni lni-dollar"></i> 70 per hpur</a></span>
                        </div>
                        <h3 class="post-title"><a href="/hallEvents">Get Your Mobile Site Ready For The 2020
                        ...
                        <a class="btn btn-common" href="/hallEvents">Show It's Events</a>
                    </div>
            ...
            <aside id="sidebar" class="col-lg-4 col-md-12 col-xs-12 right-sidebar">
                ...
                <div class="widget widget-popular-posts">
                    <h5 class="widget-title">Halls Events</h5>
                    <ul class="posts-list">
                        <li>
