            ...
            <div class="pd-20 card-box mb-30">
                ...
                <form method="post" action="{{route('halls.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" placeholder="Package Address" type="text" name="address" value="{{$category->address}}" disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" placeholder="Price per hour" type="number" name="price_per_hour" disabled value="{{$category->price_per_hour}}">
                        </div>
                    </div>
                    <div class="form-group row">
