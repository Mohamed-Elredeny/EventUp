                ...
                <form method="post" action="{{route('events.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" type="text" placeholder="Hall Title" name="title">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" placeholder="Event Price" type="number" name="price">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" placeholder="Price per hour" type="datetime-local" name="from">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">To</label>
                        <div class="col-sm-6">
                            <input class="form-control" placeholder="Price per hour" type="datetime-local" name="to">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Number Of Tickets</label>
                        <div class="col-sm-6">
                            <input class="form-control" placeholder="Number Of Tickets" type="number" min="1" name="all_ticket">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="organizer_id"  class="form-control" >
                                ...
                                @foreach($organizers as $hall)
                                    <option value="{{$hall->id}}">{{$hall->fname}} {{$hall->lname}}</option>
                                @endforeach
