    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <form method="post" action="{{route('events.update',['event'=>$category->id])}}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" placeholder="Event Price" type="number" name="price" value="{{$category->price}}" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" placeholder="Price per hour" type="date" name="from" value="{{$category->from}}"  >
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">To</label>
                        <div class="col-sm-6">
                            <input class="form-control" placeholder="Price per hour" type="date" name="to" value="{{$category->to}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Number Of Tickets</label>
                        <div class="col-sm-6">
                            <input class="form-control" placeholder="Number Of Tickets" type="number" min="1" name="all_ticket" value="{{$category->all_ticket}}">
                        </div>
                    </div>
                    <div class="form-group row">
